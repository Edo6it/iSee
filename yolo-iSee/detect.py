...
def main(_argv):
    ...
    for count, image_path in enumerate(images, 1):
        ...
        colors = infer_tl(original_image, len(allowed_classes), allowed_classes, pred_bbox)
        ...
        if FLAGS.count:
            ...
            image = utils.draw_bbox(original_image, pred_bbox, colors, FLAGS.info, counted_classes, allowed_classes=allowed_classes, read_plate = FLAGS.plate)
        else:
            image = utils.draw_bbox(original_image, pred_bbox, colors, FLAGS.info, allowed_classes=allowed_classes, read_plate = FLAGS.plate)
